...
class ProgressBar(object):
    ...
    def __init__(self,log_path, mode,epoch=None,total_epoch=None,current_loss=None,current_top1=None,model_name=None,total=None,current=None,width = 50,symbol = ">",output=sys.stderr):
        assert len(symbol) == 1
